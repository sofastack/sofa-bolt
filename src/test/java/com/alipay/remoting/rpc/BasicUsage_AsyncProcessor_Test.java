...
public class BasicUsage_AsyncProcessor_Test {
    ...
    AsyncServerUserProcessor serverUserProcessor       = new AsyncServerUserProcessor();
    AsyncClientUserProcessor clientUserProcessor       = new AsyncClientUserProcessor();
    ...
    public void testSync() throws InterruptedException {
        ...
        for (int i = 0; i < invokeTimes; i++) {
            try {
                String res = (String) client.invokeSync(addr, req, 30000000);
